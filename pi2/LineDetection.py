...
def weighted_img(img, initial_img, alpha=0.8, beta=1., ramda=0.):
    return cv2.addWeighted(initial_img, alpha, img, beta, ramda)
...
def detect_lanes_img(img):
    ...
    print(int(left_fit_line[0]), int(right_fit_line[0]))
    return final
